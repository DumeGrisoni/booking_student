...
const Login = () => {
  ...
  return (
    <div>
      {/* // <div className="mt-7 p-7 flex flex-col justify-center items-center text-primary text-default font-bold">
    //   <form action="">
    ...
    //       type="text"
    //       placeholder="Email"
    //       className="p-2 border-grey-font border rounded-md w-full mb-7"
    //     />
